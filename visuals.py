#!/Users/mikehatchi/anaconda3/bin/env/python3
# -*- coding: utf-8 -*-
...
def filter_data(data, condition):
    ...
    if op == ">":
        ...
        raise Exception("Invalid comparison operator. Only >, <, >=, <=, ==, \
!= allowed.")
...
Did you spell something wrong?".format(key))
    ...
    if(key == 'Cabin' or key == 'PassengerId' or key == 'Ticket'):
        print("'{}' has too many unique categories to display! Try a different \
feature.".format(key))
        return False
...
{} did not survive)".format(key, len(nan_outcomes), sum(nan_outcomes == 1),
                            sum(nan_outcomes == 0)))
